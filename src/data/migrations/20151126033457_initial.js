...
exports.up = function(knex, Promise) {
    return Promise.all([
        knex.schema.createTable("document", table => {
            table.increments("document_id").primary().notNullable();
            table.uuid("document_uuid").unique().notNullable().comment("UUID (v4) that can be exposed to the public instead of the PK.");
